          ...
          <div className="mt-1">
            ...
            <div className="grid grid-cols-1 gap-2 mt-1 ">
              <div className="col-span-1">
                <h1>{t({ uz: "Maydon №", en: "Field №", ru: "Поле №" })}</h1>
                <Input
                  placeholder={String(
                    t({ uz: "raqami", en: "number", ru: "номер" })
                  )}
                  size="large"
                />
              </div>
              <div className="col-span-1">
                <h1>{t({ uz: "O'lchami", en: "Size", ru: "Размер" })}</h1>
                <Select
                  size="large"
                  placeholder={t({ uz: "o'lchami", en: "size", ru: "размер" })}
                  className="w-full"
                />
              </div>
              <div className="col-span-1">
